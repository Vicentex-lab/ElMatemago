...
import colisiones as colision # Para el laberinto
import criaturas as cr         # Para el jugador y enemigos
import items as item           # Para los ítems
...
def jugar(SCREEN):
    ...
    # Colores de entidades no usados, se dibujan con sprites, pero se mantienen por si acaso.
    COLOR_CERO = (0, 0, 255)
    ...
    # Si se sale del bucle 'while running' por QUIT o ESCAPE, regresa al menú
    return True # Indica que debe ir al menú principal