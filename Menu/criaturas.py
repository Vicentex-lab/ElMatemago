...
class criature:
    def __init__(self, hp, movement_ratio, name, positions_x, positions_y, pos, exist):
...
class cero(criature):  #azul lo mata la espada (amarillo)
    positions_x=10
    positions_y=13
    hp=2
    movement_ratio=999999999999999999999999999999999
    name="Cero"
    exist=1

class pigarto(criature):  #verde
    hp=3.141592731
    movement_ratio=99999999999999999999999999999999999999999
    name="Pigarto"
    pos=0
...
class raiznegativa(criature):  #rojo, lo mata el escudo (naranjo)
    hp=6
    movement_ratio=99999999999999999999999999999999999999999
    name="Raiz negativa"
    pos=0
